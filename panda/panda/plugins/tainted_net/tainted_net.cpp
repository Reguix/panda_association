...
#include "tainted_net.h"
extern "C" {
#include "qemu/cutils.h"
#include "taint2/taint2_ext.h"
#include "panda/rr/rr_log.h"
PPP_PROT_REG_CB(on_tainted_out_net);
}
...
PPP_CB_BOILERPLATE(on_tainted_out_net);
        ...
        if (query_outgoing_network_traffic && taint2_enabled())
        {
            ...
            for (int i = 0; i < size; i++)
            {
                ...
                if (numLabels > 0)
                {
                    ...
                    fprintf(taintlogF, "\n");
                    PPP_RUN_CB(on_tainted_out_net, env, curAddr, buf[i], taint_labels, numLabels, rr_get_guest_instr_count());
            ...
            if (printNotEmpty) fprintf(taintlogF, "\n");
