 ...
 * @brief Retrieves the address of the mm_struct from a task_struct.
*/
IMPLEMENT_OFFSET_GET(get_mm_exe_file, mm_struct, target_ptr_t, ki.mm.exe_file_offset, 0)
/**
 * @brief Retrieves the address of the first mm_exe_file of the task.
 */
 IMPLEMENT_OFFSET_GET2L(get_exe_file, task_struct, target_ptr_t, ki.task.mm_offset, target_ptr_t, ki.mm.exe_file_offset, 0)
